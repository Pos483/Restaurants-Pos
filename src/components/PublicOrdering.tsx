          ...
          <div className="flex-1 flex flex-col overflow-hidden p-4 gap-4 animate-fade-in">
            <div className="relative shrink-0">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white border border-gray-150 rounded-2xl text-xs focus:outline-none focus:border-orange-500 font-bold transition-all shadow-inner"
              />
            </div>
                    ...
                    {!tableId && orderType === 'delivery' && (
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          className="w-full pl-9 pr-4 py-2.5 bg-white border border-gray-150 rounded-2xl text-xs focus:outline-none focus:border-orange-500 font-bold focus:ring-1 focus:ring-orange-500/20 resize-none"
                        />
                      </div>
                    )}
